...
Phaser.Touch.prototype = {
    ...
    */
    onTouchStart: function (event) {
        ...
        //  event.changedTouches = the touches that CHANGED in this event, not the total number of them id:306 gh:307
    ...
    */
    onTouchEnd: function (event) {
        ...
        //  event.changedTouches = the touches that CHANGED in this event, not the total number of them id:269 gh:270
        for (var i = 0; i < event.changedTouches.length; i++)
        {
            this.game.input.stopPointer(event.changedTouches[i]);
        }
