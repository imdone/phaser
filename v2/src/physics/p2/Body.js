...
Phaser.Physics.P2.Body = function (game, sprite, x, y, mass) {
    ...
    */
    ...
    /**
    * @property {Phaser.Point} gravity - A locally applied gravity force to the Body. Applied directly before the world step. NOTE: Not currently implemented. id:184 gh:185
    */
