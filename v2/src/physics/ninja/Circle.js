        ...
        if (oH === 0)
        {
            if (oV === 0)
            {
                ...
                if (x < y)
                {
                    ...
                    //NOTE: should we handle the delta === 0 case?! and how? (project towards oldpos?) id:226 gh:227
                    if (dx < 0)
                    {
                ...
                else
                {
                    ...
                    //NOTE: should we handle the delta === 0 case?! and how? (project towards oldpos?) id:205 gh:206
                    if (dy < 0)
                    {
