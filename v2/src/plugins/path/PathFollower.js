...
Phaser.PathFollower = function (path, follower, speed, rotationOffset, angularOffset, callbackAtEnd, physicsAdjustTime) {
    ...
    // NOTE: if there are multiple counted PathPoints this will not work as expected as there is only one count variable per follower! id:229 gh:230
    this.branchCount = 0;
    ...
    follower.events.onPathStart = new Phaser.Signal(); // NOTE: not "follower started a path" but "follower moved backwards to the start of the path" id:300 gh:301
...
Phaser.PathFollower.EVENT_PATH_START = "event_path_start";         // NOTE: "a path started" but "follower moved backwards to the start of the path" id:248 gh:249
