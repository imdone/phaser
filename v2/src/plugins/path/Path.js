...
Phaser.Path.prototype = {
    ...
    * 
    * NOTE: because this is a PathPoint reference, it does not take into account the coordinateSystem selected, it will be WORLD, or OFFSET unmodified id:244 gh:245
    *
